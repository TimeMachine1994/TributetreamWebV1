<script lang="ts">
  ...
  let events = $state<MemorialEvent[]>(data.tribute.attributes.events || []);
...
<div class="container mx-auto p-4">
  <div class="mb-6 flex justify-between items-center">
    <h1 class="text-2xl font-bold">Edit Tribute</h1>
    <button
  ...
  <form method="POST" action="?/update" class="max-w-2xl">
    <div class="mb-4">
      ...
      <input
        ...
        required
        value={form?.data?.lovedOnesFullName ?? data.tribute.attributes.lovedOnesFullName}
    ...
    <div class="mb-4">
      ...
      <input
        ...
        name="lovedOnesDOB"
        required
        value={form?.data?.lovedOnesDOB ?? data.tribute.attributes.lovedOnesDOB}
        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
      />
    </div>
    ...
    <div class="mb-4">
      ...
      <input
        ...
        name="lovedOnesDOD"
        required
        value={form?.data?.lovedOnesDOD ?? data.tribute.attributes.lovedOnesDOD}
        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
      />
    </div>
      ...
      >
        ...
        {#each data.funeralHomes as funeralHome}
          <option 
            ...
            selected={funeralHome.id === data.tribute.attributes.funeral_home?.data?.id}
          >
    ...
    <div class="mb-4">
      ...
      >
        ...
        {#each data.packages as pkg}
          <option 
            value={pkg.id}
            selected={pkg.id === data.tribute.attributes.package?.data?.id}
          >
    ...
    <div class="mb-4">
      ...
      >
        ...
        {#each data.users as user}
          <option
            value={user.id}
            selected={user.id === data.tribute.attributes.users_permissions_user?.data?.id}
          >
            {user.email}
          </option>
        {/each}
        ...
        {#each data.users as user}
          <label class="flex items-center mb-2">
            <input
              ...
              value={user.id}
              checked={data.tribute.attributes.users_permissions_users?.data?.some((u: { id: number }) => u.id === user.id)}
              class="mr-2"
            />
    ...
    <div class="mb-4">
      <label class="flex items-center">
        <input
          ...
          checked={form?.data?.paymentComplete ?? data.tribute.attributes.paymentComplete}
          class="mr-2"
        />
    ...
    <div class="mb-6">
      ...
      <textarea
        ...
        rows="6"
        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
      >{form?.data?.customHTML ?? data.tribute.attributes.customHTML}</textarea>
    </div>
  ...
  {#if showDeleteConfirm}
    <div class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
      <div class="bg-white p-6 rounded-lg">
        ...
        <p class="mb-4">Are you sure you want to delete this tribute? This action cannot be undone.</p>
