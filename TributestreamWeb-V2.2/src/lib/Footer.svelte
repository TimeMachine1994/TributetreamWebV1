          ...
          <footer class="bg-black text-white py-12">
            <div class="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
              ...
              <div>
                ...
                <a href="/fd-form">
                  <button
                    class="mt-4 bg-blue-500 text-white py-2 px-4 border border-transparent rounded-lg hover:shadow-[0_0_10px_4px_#3b82f6] transition-all duration-300 ease-in-out"
                  >
