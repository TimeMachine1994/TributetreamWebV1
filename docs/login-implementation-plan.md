...
- ✅ Unit test login API route
- ✅ E2E test login flow using Playwright
- ✅ Test JWT cookie set and cleared
- ✅ Test user data fetch with valid/invalid JWT

---

## 🔐 Security Considerations

- Use `HttpOnly`, `Secure`, `SameSite=Lax` for JWT cookie
- Never expose JWT to client-side JS
